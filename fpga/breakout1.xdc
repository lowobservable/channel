...
set_property -dict { PACKAGE_PIN G19 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[7] }]; # Bus In 7
set_property -dict { PACKAGE_PIN L19 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[7] }]; # Bus Out 7
set_property -dict { PACKAGE_PIN D18 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[6] }]; # Bus In 6
set_property -dict { PACKAGE_PIN J18 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[6] }]; # Bus Out 6
set_property -dict { PACKAGE_PIN D20 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[5] }]; # Bus In 5
set_property -dict { PACKAGE_PIN G20 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[5] }]; # Bus Out 5
set_property -dict { PACKAGE_PIN C20 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[4] }]; # Bus In 4
set_property -dict { PACKAGE_PIN K17 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[4] }]; # Bus Out 4
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[3] }]; # Bus In 3
set_property -dict { PACKAGE_PIN F19 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[3] }]; # Bus Out 3
set_property -dict { PACKAGE_PIN B20 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[2] }]; # Bus In 2
set_property -dict { PACKAGE_PIN E19 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[2] }]; # Bus Out 2
set_property -dict { PACKAGE_PIN B19 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[1] }]; # Bus In 1
set_property -dict { PACKAGE_PIN F20 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[1] }]; # Bus Out 1
set_property -dict { PACKAGE_PIN H16 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_IN_N[0] }]; # Bus In 0
set_property -dict { PACKAGE_PIN D19 IOSTANDARD LVCMOS33 } [get_ports { A_BUS_OUT[0] }]; # Bus Out 0
