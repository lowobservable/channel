...
#
# Generated by Vivado on Sat Jun 15 17:10:20 CDT 2024
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/rtl/wrap_test.v"]"\
...
# module references:
# axi_channel, axi_mock_cu, frontend_a, wrap_test
...
\
  ...
  # Create instance: wrap_test_0, and set properties
  set block_name wrap_test
  set block_cell_name wrap_test_0
  if { [catch {set wrap_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $wrap_test_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net A_BUS_IN_PARITY_N_1 [get_bd_ports A_BUS_IN_PARITY_N] [get_bd_pins frontend_a_0/a_bus_in_parity_n]
  connect_bd_net -net A_DATA_IN_N_1 [get_bd_ports A_DATA_IN_N] [get_bd_pins frontend_a_0/a_data_in_n]
  connect_bd_net -net A_DISCONNECT_IN_N_1 [get_bd_ports A_DISCONNECT_IN_N] [get_bd_pins frontend_a_0/a_disconnect_in_n]
  connect_bd_net -net A_MARK_0_IN_N_1 [get_bd_ports A_MARK_0_IN_N] [get_bd_pins frontend_a_0/a_mark_0_in_n]
  connect_bd_net -net A_METERING_IN_N_1 [get_bd_ports A_METERING_IN_N] [get_bd_pins frontend_a_0/a_metering_in_n]
  ...
  connect_bd_net -net axi_mock_cu_0_a_select_out [get_bd_pins axi_mock_cu_0/a_select_out] [get_bd_pins axi_mock_cu_0/a_select_in]
  ...
  connect_bd_net -net frontend_a_0_a_bus_out_parity [get_bd_pins frontend_a_0/a_bus_out_parity] [get_bd_ports A_BUS_OUT_PARITY]
  connect_bd_net -net frontend_a_0_a_clock_out [get_bd_pins frontend_a_0/a_clock_out] [get_bd_ports A_CLOCK_OUT]
  connect_bd_net -net frontend_a_0_a_command_out [get_bd_pins frontend_a_0/a_command_out] [get_bd_ports A_COMMAND_OUT]
  connect_bd_net -net frontend_a_0_a_data_out [get_bd_pins frontend_a_0/a_data_out] [get_bd_ports A_DATA_OUT]
  connect_bd_net -net frontend_a_0_a_hold_out [get_bd_pins frontend_a_0/a_hold_out] [get_bd_ports A_HOLD_OUT]
  connect_bd_net -net frontend_a_0_a_mark_0_out [get_bd_pins frontend_a_0/a_mark_0_out] [get_bd_ports A_MARK_0_OUT]
  connect_bd_net -net frontend_a_0_a_metering_out [get_bd_pins frontend_a_0/a_metering_out] [get_bd_ports A_METERING_OUT]
  ...
  connect_bd_net -net frontend_a_0_b_address_in [get_bd_pins frontend_a_0/b_address_in] [get_bd_pins wrap_test_0/a_address_in]
  connect_bd_net -net frontend_a_0_b_bus_in [get_bd_pins frontend_a_0/b_bus_in] [get_bd_pins wrap_test_0/a_bus_in]
  connect_bd_net -net frontend_a_0_b_bus_in_parity [get_bd_pins frontend_a_0/b_bus_in_parity] [get_bd_pins wrap_test_0/a_bus_in_parity]
  connect_bd_net -net frontend_a_0_b_data_in [get_bd_pins frontend_a_0/b_data_in] [get_bd_pins wrap_test_0/a_data_in]
  connect_bd_net -net frontend_a_0_b_disconnect_in [get_bd_pins frontend_a_0/b_disconnect_in] [get_bd_pins wrap_test_0/a_disconnect_in]
  connect_bd_net -net frontend_a_0_b_mark_0_in [get_bd_pins frontend_a_0/b_mark_0_in] [get_bd_pins wrap_test_0/a_mark_0_in]
  connect_bd_net -net frontend_a_0_b_metering_in [get_bd_pins frontend_a_0/b_metering_in] [get_bd_pins wrap_test_0/a_metering_in]
  connect_bd_net -net frontend_a_0_b_operational_in [get_bd_pins frontend_a_0/b_operational_in] [get_bd_pins wrap_test_0/a_operational_in]
  connect_bd_net -net frontend_a_0_b_request_in [get_bd_pins frontend_a_0/b_request_in] [get_bd_pins wrap_test_0/a_request_in]
  connect_bd_net -net frontend_a_0_b_select_in [get_bd_pins frontend_a_0/b_select_in] [get_bd_pins wrap_test_0/a_select_in]
  connect_bd_net -net frontend_a_0_b_service_in [get_bd_pins frontend_a_0/b_service_in] [get_bd_pins wrap_test_0/a_service_in]
  connect_bd_net -net frontend_a_0_b_status_in [get_bd_pins frontend_a_0/b_status_in] [get_bd_pins wrap_test_0/a_status_in]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_channel_0/aclk] [get_bd_pins axi_mock_cu_0/aclk] [get_bd_pins frontend_a_0/clk] [get_bd_pins wrap_test_0/clk]
  ...
  connect_bd_net -net wrap_test_0_a_address_out [get_bd_pins wrap_test_0/a_address_out] [get_bd_pins frontend_a_0/b_address_out]
  connect_bd_net -net wrap_test_0_a_bus_out [get_bd_pins wrap_test_0/a_bus_out] [get_bd_pins frontend_a_0/b_bus_out]
  connect_bd_net -net wrap_test_0_a_bus_out_parity [get_bd_pins wrap_test_0/a_bus_out_parity] [get_bd_pins frontend_a_0/b_bus_out_parity]
  connect_bd_net -net wrap_test_0_a_clock_out [get_bd_pins wrap_test_0/a_clock_out] [get_bd_pins frontend_a_0/b_clock_out]
  connect_bd_net -net wrap_test_0_a_command_out [get_bd_pins wrap_test_0/a_command_out] [get_bd_pins frontend_a_0/b_command_out]
  connect_bd_net -net wrap_test_0_a_data_out [get_bd_pins wrap_test_0/a_data_out] [get_bd_pins frontend_a_0/b_data_out]
  connect_bd_net -net wrap_test_0_a_hold_out [get_bd_pins wrap_test_0/a_hold_out] [get_bd_pins frontend_a_0/b_hold_out]
  connect_bd_net -net wrap_test_0_a_mark_0_out [get_bd_pins wrap_test_0/a_mark_0_out] [get_bd_pins frontend_a_0/b_mark_0_out]
  connect_bd_net -net wrap_test_0_a_metering_out [get_bd_pins wrap_test_0/a_metering_out] [get_bd_pins frontend_a_0/b_metering_out]
  connect_bd_net -net wrap_test_0_a_operational_out [get_bd_pins wrap_test_0/a_operational_out] [get_bd_pins frontend_a_0/b_operational_out]
  connect_bd_net -net wrap_test_0_a_select_out [get_bd_pins wrap_test_0/a_select_out] [get_bd_pins frontend_a_0/b_select_out]
  connect_bd_net -net wrap_test_0_a_service_out [get_bd_pins wrap_test_0/a_service_out] [get_bd_pins frontend_a_0/b_service_out]
  connect_bd_net -net wrap_test_0_a_suppress_out [get_bd_pins wrap_test_0/a_suppress_out] [get_bd_pins frontend_a_0/b_suppress_out]
  connect_bd_net -net wrap_test_0_frontend_enable [get_bd_pins wrap_test_0/frontend_enable] [get_bd_pins frontend_a_0/enable]
  connect_bd_net -net wrap_test_0_test_receiver [get_bd_pins wrap_test_0/test_receiver] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_ports GPIO_0] [get_bd_ports GPIO_1]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins axi_mock_cu_0/a_request_in] [get_bd_pins axi_mock_cu_0/a_operational_in] [get_bd_pins axi_mock_cu_0/a_address_in] [get_bd_pins axi_mock_cu_0/a_status_in] [get_bd_pins axi_mock_cu_0/a_service_in]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconstant_2/dout] [get_bd_pins axi_mock_cu_0/a_bus_in]
